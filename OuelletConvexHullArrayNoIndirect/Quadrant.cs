		...
		public void Calc(bool isSkipSetQuadrantLimits = false)
		{
			...
			foreach (Point point in _listOfPoint)
			{
				...
				if (indexLow + 1 == indexHi)
				{
					...
					Unsafe.PointArrayUtilUnsafe.InsertItem(ref HullPoints, point, indexHi, ref HullPointCount);
				}
				else
				{
					...
					if (indexLow + 2 < indexHi)
					{
						...
						Unsafe.PointArrayUtilUnsafe.RemoveRange(ref HullPoints, indexLow + 2, indexHi - indexLow - 2, ref HullPointCount);
					}
				}
			}
		}
