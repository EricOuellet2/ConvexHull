...
namespace OuelletConvexHullArray
{
	public class ConvexHull
	{
		...
		private PointArrayManipulationType _pointArrayManipulationType;
		// ******************************************************************
		...
		private void Init(IReadOnlyList<Point> listOfPoint, bool shouldCloseTheGraph, int initialResultGuessSize)
		{
			...
			if (_pointArrayManipulationType ==  PointArrayManipulationType.ArrayCopyImmutable)
			{
				initialResultGuessSize = 0;
			}
